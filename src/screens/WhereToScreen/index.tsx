...
const WhereToScreen: React.FC<WhereToScreenProps> = () => {
    ...
    const handleRideHistoryCardPress = () => {
        navigation.navigate('RideHistoryDetails', {
            // Pass any necessary params here, e.g., ride details
        });
    };
